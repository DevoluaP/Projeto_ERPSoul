...
export default function RelatoriosServicos({
  ...
  const handleSubmit = (e) => {
    ...
    if (
      ...
      fetch("http://localhost:5000/api/services/reports", {
        method: "POST",
        headers: {
    ...
    if (servicos.length > 0) {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          fetch("http://localhost:5000/api/services/exportReports", {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
            },
  ...
  const exportToText = (servicos) => {
    let texto =
      "N° Serviço | Código LC-116 | Código do Serviço | Cliente | Serviço | Descrição do Serviço | Valor do Serviço | Alíquota ISS | Natureza | Data de Vencimento | Status\n";
              ...
              {servicos.length === 0 ? (
                ...
                servicos.map((servico, index) => (
                  <tr key={index}>
                    ...
                    <td>
                      {parseFloat(servico.valor_servico).toLocaleString(
                        "pt-BR",
                    ...
                    <td>
                      {new Date(servico.dt_vencimento).toLocaleDateString(
                        "pt-BR",
                      )}
                    </td>
                    <td>
