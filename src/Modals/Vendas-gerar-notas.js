                ...
                <div className="formulario">
                    <form action="" method="POST">
                        <div className="info">
                            ...
                            <div className="row">
                                <div className="col-6">
                                    <select name="saida" id="saida" required="required">
                            ...
                            <div className="row">
                                <div className="col-6">
                                    <select name="finalidade" id="finalidade" required="required">
                        ...
                        <div className="info">
                            ...
                            <div className="row">
                                <div className="col-6">
                                    <select name="tipo-pessoa" id="tipo-pessoa" required="required">
