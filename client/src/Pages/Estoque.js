...
import ProdutosCadastrados from "../Modals/Produtos-cadastrados.js";
            ...
            <div class="central">
              ...
              {openModal && (
                <div className="modal-overlay">
                  <div className="modal-container">
                    <CadastrarProduto
                      isOpenCadastrarProduto={openModal}
              ...
              {openModal2 && (
                <div className="modal-overlay">
                  <div className="modal-container">
                    <ProdutosCadastrados
                      isOpenProdutosCadastrados={openModal2}
                      setCloseModal={setCloseModal}
                    />
                    <div className="botoes">
                      <button className="close-btn" onClick={setCloseModal}>
              ...
              {openModal3 && (
                <div className="modal-overlay">
                  <div className="modal-container">
                    <RelatoriosEstoque
                      isOpenRelatoriosEstoque={openModal3}
                      setCloseModal={setCloseModal}
                    />
                    <div className="botoes">
                      <button className="close-btn" onClick={setCloseModal}>
